...
\begin{frame}[allowframebreaks]{Buenas practicas de programación}
\begin{itemize}
...
\item<9-> Proyectos con aproximadamente más de 50 millones de líneas de código
\begin{itemize}
\item<10->  Colisionador de hadrones
\item<11->  Windows Vista
\item<12->  Debian 5.0
\end{itemize}
...
Ejemplo	: scanf("$\%d$", $\&$edad); \\ 
 ...
 \begin{block}{Printf}
Es una función de la li\begin{enumerate}
...
\end{enumerate}brería de entrada/salida \begin{enumerate}
\item<1->  Las operaciones de multiplicación, división y módulo se resuelven primero. Si en una misma operación aparecen varias de ellas, se resuelven de izquierda a derecha
...
\end{enumerate}de C que permite imprimir información por pantalla.\\ 
