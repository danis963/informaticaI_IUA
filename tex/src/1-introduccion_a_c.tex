...
\begin{block}{}
Los operadores lógicos proporcionan un resultado a partir de que se cumpla o no una cierta condición. Sus operandos y su resultados son valores booleanos (verdadero o falso).
\end{block}
