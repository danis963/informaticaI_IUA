...
Está compuesta únicamente por una sola condición. Si al evaluarla resulta verdadera, se ejecutará la acción o acciones. Por el contrario, si la condición es falsa, no hará nada.
\end{block}
